...
static const int64 MAX_MONEY = 9960776.19648 * COIN; // 金 Jīn: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / (79.0/60.0)) / 250; // 金 Jīn: Priority cutoff is 2 金 Jīn day / 250 bytes.
    }
